...
pos_ini=plat1.rect.x
plat2=Plataforma(150,40,600,450)
plat3=Plataforma(100,30,400,350)
plat4=Plataforma(150,40,1000,450)
plat5=Plataforma(100,30,1200,350)
plat6=Plataforma(100,30,1400,220)
plat7=Plataforma(150,40,2600,450)
plat8=Plataforma(100,30,2800,350)
plat9=Plataforma(150,40,3000,220)
plat10=Plataforma(100,30,3500,220)
...
rat2=Rat(rats,4,paredes)
rat3=Rat(rats,4,paredes)
rat4=Rat(rats,4,paredes)
rat5=Rat(rats,4,paredes)
enemigos_rata.add(rat,rat2,rat3,rat4,rat5)
spider=Spider(spiders,3)
spider2=Spider(spiders,3)
spider3=Spider(spiders,3)
enemigos_spider.add(spider, spider2, spider3)
enemigos.add(enemigos_rata,enemigos_spider)
plataformas.add(plat1,plat2,plat3,plat4,plat5,plat6,plat7,plat8,plat9,plat10)
...
rat2.rect.x=random.randint(0,espacio-rat.rect.width)
rat2.rect.y=600-(rat2.size[1])
rat3.rect.x=random.randint(0,espacio-rat.rect.width)
rat3.rect.y=600-(rat2.size[1])
rat4.rect.x=random.randint(0,espacio-rat.rect.width)
rat4.rect.y=600-(rat4.size[1])
rat5.rect.x=random.randint(0,espacio-rat.rect.width)
rat5.rect.y=600-(rat5.size[1])

spider.rect.x= random.randint(0,espacio-spider.rect.width)
spider.rect.y= random.randint(0,399)
spider2.rect.x= random.randint(0,espacio-spider.rect.width)
spider2.rect.y= random.randint(0,399)
spider3.rect.x= random.randint(0,espacio-spider.rect.width)
spider3.rect.y= random.randint(0,399)
...
while Nivel1 == True:
    ...
    if vidas >0:
        if mover_fondo == True or jugador.speed_x!=0:
            fondo_x += dfx
            if ancho-espacio+pos_ini<=plat1.rect.x+dfx<=pos_ini:
